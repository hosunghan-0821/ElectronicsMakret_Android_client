...
public class Fragment_sell_cancel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_sell_reservation, container, false);
        variableInit(view);

        RetrofitService service = retrofit.create(RetrofitService.class);
        Call<PostAllInfo> call = service.getPostAllInfo(cursorPostNum,phasingNum,"cancelSellInfo",id);
...
//                                        adapter.notifyItemRemoved(beforePosition-1);
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Call<PostAllInfo> call = service.getPostAllInfo(cursorPostNum,"update","cancelSellInfo",id);
                call.enqueue(new Callback<PostAllInfo>() {
                    @Override
                    public void onResponse(Call<PostAllInfo> call, Response<PostAllInfo> response) {
    ...
    public void variableInit(View view){
        ...
        //해당 recyclerview 관련
        cancelRecyclerView=view.findViewById(R.id.sell_cancel_recyclerview);
