...
public class Activity_video_call extends AppCompatActivity {
    ...
    private String serverURL = "https://305e-1-227-215-212.ngrok.io";
...
//                mp.reset();
//                mp=MediaPlayer.create(Activity_video_call.this,R.raw.callingsound);
                mp.start();
            }
        });
...
//                                Message msg = new Message();
//                                Bundle bundle = new Bundle();
//                                bundle.putString("purpose", "finishCall");
//                                msg.setData(bundle);
//                                handler.sendMessage(msg);
//                            }catch (Exception e){
//
...
//                    thread.start();
                ...
                else if(purpose.equals("finishCall")){
